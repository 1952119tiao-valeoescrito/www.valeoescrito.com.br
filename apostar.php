...
<?php
         ...
         if(empty($num_extracao)):
            echo "<script>alert('Preencha o campo Extra  o n :')</script>";
            ...
            echo "<script>alert('Preencha o campo Token n :')</script>";
            echo "<script>history.back()</script>";
            exit;
            ...
            echo "<script>alert('Preencha o campo 1  Pr mio:')</script>";
            echo '<script>history.back()</script>';
            exit;
            elseif(empty($seg_premio)):
            echo "<script>alert('Preencha o campo 2  Pr mio:')</script>";
            echo "<script>history.back()</script>";
            exit;
            elseif(empty($ter_premio)):
            echo "<script>alert('Preencha o campo 3  Pr mio:')</script>";
            echo "<script>history.back()</script>";
            exit;
            elseif(empty($qua_premio)):
            echo "<script>alert('Preencha o campo 4  Pr mio:')</script>";
            echo "<script>history.back()</script>";
            exit;
            elseif(empty($qui_premio)):
            echo "<script>alert('Preencha o campo 5  Pr mio:')</script>";
            echo "<script>history.back()</script>";
            exit;
            else:
...
<table align="center" border="0" cellpadding="1" cellspacing="1" style="height: 690px; width: 617px">
	<tbody>
		<tr>
			<td colspan="10" style="text-align: left"><input alt="" size="1" src="https://www.valeoescrito.com.br/OIG1.jpeg" style="height: 150px; width: 700px" type="image" /></td>
		</tr>
		<tr>
...
<tr>
		...
		<tr>
			...
			<span style="font-size: 14px"><strong><span style="font-family: arial, helvetica, sans-serif; white-space: normal; word-spacing: 0px; text-transform: none; float: none; font-weight: 400; font-style: normal; text-align: center; orphans: 2; widows: 2; display: inline !important; letter-spacing: normal; text-indent: 0px; -webkit-text-stroke-width: 0px; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; font-variant-ligatures: normal; font-variant-caps: normal"><span style="color: #ff0000">D&uacute;vidas? Envie um e-mail para </span><a href="mailto:suporte@valeoescrito.com.br.com.br"><span style="color: #000080"><span>suporte@valeoescrito.com.br</span></span></a><span style="color: #000080">&nbsp;</span><span style="color: #ff0000">- WhatsApp:&nbsp;</span><span style="color: #000080">+55 (21) 99352-7957</span><span style="color: #ff0000">.</span></span></strong></span></td>
		</tr>
		<tr>
